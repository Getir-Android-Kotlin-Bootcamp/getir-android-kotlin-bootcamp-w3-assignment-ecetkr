...
class OnboardingFavoritiesFragment : Fragment(R.layout.fragment_onboarding_favorities) {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_onboarding_favorities, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        nextButton = view.findViewById(R.id.bt_next2)
        nextButton.setOnClickListener{
            findNavController().navigate(R.id.action_onboardingFavoritiesFragment_to_onboardingCheapFragment2)
        }
    }
